...
class BarbicanKeyManagerTestCase(test_key_manager.KeyManagerTestCase):
    ...
    def setUp(self):
        ...
        self.hex = (
            "0080f1429dbefae01b29a4d50cc5c5608bbc3c8ba0246aa42b424baa4534ae16"
        )
    ...
    def test_barbican_endpoint(self):
        ...
        auth.service_catalog.endpoint_data_for.assert_called_once_with(
            service_type='key-manager', interface='public', region_name=None
        )
    ...
    def test_barbican_endpoint_with_endpoint_type(self):
        ...
        self.assertEqual(endpoint, 'http://localhost:9311')
        auth.service_catalog.endpoint_data_for.assert_called_once_with(
            service_type='key-manager', interface='internal', region_name=None
        )
    ...
    def test_create_key(self, mock_get_client):
        ...
        returned_uuid = self.key_mgr.create_key(
    ...
    def test_create_key_pair(self, mock_get_client):
        ...
        mock_client.orders.get.assert_called_once_with(order_ref_url)
        mock_client.containers.get.assert_called_once_with(container_ref)
        mock_client.orders.delete.assert_called_once_with(order_ref_url)
    ...
    def test_create_key_pair_error_in_delete_order_container(
    ...
    def test_delete_null_context(self):
        self.assertRaises(
            exception.Forbidden, self.key_mgr.delete, None, self.key_id
        )
    ...
    def test_get_null_context(self):
        self.assertRaises(
            exception.Forbidden, self.key_mgr.get, None, self.key_id
        )
    ...
    def test_get_with_error(self, mock_get_client):
        ...
        self.assertRaises(
            exception.KeyManagerError, self.key_mgr.get, self.ctxt, self.key_id
        )
    ...
    def test_store_with_error(self, mock_get_client):
        ...
        _key = sym_key.SymmetricKey('AES', key_length, secret_key)
        self.assertRaises(
            exception.KeyManagerError, self.key_mgr.store, self.ctxt, _key
        )
    ...
    def test_get_active_order_timeout(self, mock_get_client):
        ...
        self.assertEqual(
            number_of_retries + 1, mock_client.orders.get.call_count
        )
    ...
    def test_get_active_order_error(self, mock_get_client):
        ...
        error_order.error_status_code = "500"
        error_order.error_reason = "Test Error"
    ...
    def test_list(self, mock_get_client):
        ...
        mock_client.secrets.list.return_value = [original_secret_metadata]
    ...
    def test_list_with_error(self, mock_get_client):
        ...
        self.assertRaises(
            exception.KeyManagerError, self.key_mgr.list, self.ctxt
        )
    ...
    def test_add_consumer_with_null_service_fails(self, mock_get_client):
        mock_client = mock.Mock()
        mock_get_client.return_value = mock_client
    ...
    def test_add_consumer_with_empty_service_fails(self, mock_get_client):
        mock_client = mock.Mock()
        mock_get_client.return_value = mock_client
    ...
    def test_add_consumer_with_null_resource_type_fails(self, mock_get_client):
        mock_client = mock.Mock()
        mock_get_client.return_value = mock_client
        ...
        side_effect = barbican_exceptions.HTTPClientError(
            ...
            "Invalid property: 'resource_type'",
            status_code=400,
        )
        self._test_add_consumer_expects_error(
            mock_client,
    ...
    def test_add_consumer_with_null_resource_id_fails(self, mock_get_client):
        mock_client = mock.Mock()
        mock_get_client.return_value = mock_client
    ...
    def test_add_consumer_with_empty_resource_id_fails(self, mock_get_client):
        mock_client = mock.Mock()
        mock_get_client.return_value = mock_client
    ...
    def test_remove_consumer_with_empty_service_fails(self, mock_get_client):
        mock_client = mock.Mock()
        mock_get_client.return_value = mock_client
