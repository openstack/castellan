...
release = pbr_version.VersionInfo('castellan').version_string_with_vcs()
# The short X.Y version.
version = pbr_version.VersionInfo('castellan').canonical_version_string()
...
htmlhelp_basename = 'CastellanReleaseNotesdoc'
